    ...
    inquirer.prompt([
        ...
        validate: addDept => {
            if (addDept) {
                ...
                console.table('Please enter a department');
                return false;
            }
        }
        }
    ...
    inquirer.prompt([
        ...
        validate: addRole => {
            if (addRole) {
                ...
                console.table('Please enter a role');
                return false;
            }
        }
        },
        ...
        validate: addSalary => {
            if (addSalary) {
                ...
                console.table('Please enter a salary');
                return false;
            }
        }
        }
    ...
    inquirer.prompt([
      {
        ...
        validate: addFirst => {
          if (addFirst) {
              ...
              console.table('Please enter a first name');
              return false;
          }
        }
      },
      {
        ...
        validate: addLast => {
          if (addLast) {
              ...
              console.table('Please enter a last name');
              return false;
          }
        }
      }
